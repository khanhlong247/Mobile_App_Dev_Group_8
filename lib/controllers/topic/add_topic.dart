      ...
      child: Scaffold(
        appBar: AppBar(
          leading: IconButton(
            ...
            onPressed: () {
              // Khi nhấn nút quay lại thì chuyển sang HomeScreen
                  ...
                  child: Column(
                    ...
                    children: [
                      TextFormField(
                        ...
                        validator: (value) =>
                            value!.isEmpty ? 'Enter travel title' : null,
                      ),
                      ...
                      TextFormField(
                        ...
                        validator: (value) =>
                            value!.isEmpty ? 'Enter travel description' : null,
                      ),
                      const SizedBox(height: 20),
                      ElevatedButton(
                        onPressed: () async {
                          if (_formKey.currentState!.validate()) {
                            ...
                            try {
                              ...
                              await topicRef.child(date.toString()).set({
                                ...
                                // Chuyển sang HomeScreen thay vì pop()
                                Navigator.pushReplacement(
                                  context,
                                  MaterialPageRoute(
